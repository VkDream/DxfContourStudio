...
public static class LocalizedStringsZhCn
{
    ...
    private static IReadOnlyDictionary<string, string> Build()
    {
        var d = new Dictionary<string, string>(System.StringComparer.Ordinal)
        {
            ...
            ["Menu.Edit.Join"] = "合并已选实体",
            ["Menu.Edit.Break"] = "平分打断",
            ["Menu.Edit.TrimStart"] = "向边界修剪（保起点）",
            ["Menu.Edit.TrimEnd"] = "向边界修剪（保终点）",
            ["Menu.Edit.Extend"] = "延伸至边界",
            ["Menu.Edit.Tools.Select"] = "选择",
            ["Menu.Edit.Tools.NodeEdit"] = "编辑节点",
            ["Menu.Edit.Tools.Join"] = "合并工具",
            ["Menu.Edit.Tools.Break"] = "打断工具",
            ["Menu.Edit.Tools.Trim"] = "修剪工具",
            ["Menu.Edit.Tools.Extend"] = "延伸工具",
            ["Menu.Tools.Snap"] = "捕捉",
            ["Menu.Tools.SnapSettings"] = "捕捉设置",
            ["Snap.Kind.Endpoint"] = "端点",
            ["Snap.Kind.Midpoint"] = "中点",
            ["Snap.Kind.Center"] = "圆心",
            ["Snap.Kind.Intersection"] = "交点",
            ["Snap.Kind.Nearest"] = "最近点",
            ["Status.Extended"] = "实体已延伸",
            ["Status.NoUniqueExtendBoundary"] = "未找到唯一可延伸边界",
            ["Status.NodeEditUpdated"] = "节点已更新",
            ["Status.NodeEditInvalid"] = "编辑结果无效，已取消。",
            ["Status.SnapOff"] = "捕捉：关",
            ["Status.SnapActive"] = "捕捉：{0}",
            ...
            ["Tooltip.NodeEdit"] = "编辑节点（拖动夹点移动）",
            ["Tooltip.Join"] = "合并：依次点击两个开放端点",
            ["Tooltip.Break"] = "打断：在断点处点击图元",
            ["Tooltip.Trim"] = "修剪：先点路径，再点要移除的区段",
            ["Tooltip.Extend"] = "延伸：靠近要拉伸的一端点击图元",
            ["Tool.Name.Select"] = "选择",
            ["Tool.Name.NodeEdit"] = "节点编辑",
            ["Tool.Name.Join"] = "合并",
            ["Tool.Name.Break"] = "打断",
            ["Tool.Name.Trim"] = "修剪",
            ["Tool.Name.Extend"] = "延伸",
            ["Status.AnalysisStale"] = "分析结果已过期——几何已修改，请重新分析",
            ["EditTools.Join.NoEndpoint"] = "此处没有开放端点",
            ["EditTools.Join.PickSecond"] = "请选择第二个开放端点",
            ["EditTools.Join.SameEndpoint"] = "已选择该端点",
            ["EditTools.Join.NotConnected"] = "端点不相连",
            ["EditTools.Join.Ambiguous"] = "存在多个匹配端点",
            ["EditTools.Join.DifferentLayers"] = "图元位于不同图层",
            ["EditTools.Join.Unsupported"] = "这些图元无法合并",
            ["EditTools.Break.NoTarget"] = "此处没有可打断的图元",
            ["EditTools.Break.NotOnTarget"] = "请点击要打断的图元",
            ["EditTools.Break.EndpointGuard"] = "不能在端点处打断",
            ["EditTools.Trim.NoTarget"] = "此处没有可修剪的图元",
            ["EditTools.Trim.UnsupportedTarget"] = "只能修剪直线和圆弧",
            ["EditTools.Trim.PickSection"] = "请选择要移除的区段",
            ["EditTools.Trim.NotOnTarget"] = "请点击目标路径",
            ["EditTools.Trim.NoBoundary"] = "未找到边界",
            ["EditTools.Trim.InvalidSection"] = "整条路径都会被移除",
            ["EditTools.Trim.TinyKeptPiece"] = "保留段过小",
            ["EditTools.Extend.NoTarget"] = "此处没有可延伸的图元",
            ["EditTools.Extend.PickEnd"] = "请选择要延伸的一端",
            ["EditTools.Extend.NoBoundary"] = "没有符合条件的边界",
            ...
            ["Status.Joined"] = "已合并 {0} 个实体",
            ["Status.Broken"] = "实体已打断为两段",
            ["Status.Trimmed"] = "实体已修剪",
            ["Status.EditNeedTwo"] = "请至少选择两个实体以合并",
            ["Status.EditNeedOne"] = "请恰好选择一个实体",
            ["Status.EditNeedLine"] = "修剪需要目标和边界两个实体",
